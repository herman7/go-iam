...
var (
	...
	password = pflag.StringP("password", "p", "admin", "Password for access to mysql, should be used pair with password")
	database = pflag.StringP("database", "d", "go_test_1", "Database name to use")
